...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-[#0A0D18] text-[#EDEFF7] pb-20 sm:pb-0" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      {/* Radial glow bg */}
      ...
      <div className="relative max-w-[1040px] mx-auto px-5">
        ...
        <nav className="flex items-center justify-between py-5">
          <Link href="/" className="font-bold text-[22px] tracking-tight" style={{ fontFamily: "'Space Grotesk', system-ui, sans-serif" }}>
        ...
        <header className="grid grid-cols-1 md:grid-cols-[1.05fr_0.95fr] gap-8 md:gap-12 items-center py-10 md:py-12">
          <div>
            <div className="flex items-center gap-2 text-[#F4E96B] text-xs tracking-[0.32em] uppercase mb-5" style={{ fontFamily: "'Space Mono', monospace" }}>
              <span className="w-[7px] h-[7px] rounded-full bg-[#F4E96B] animate-pulse-gold" />
              The stock market for creators
            </div>
            <h1 className="font-bold leading-[1.02] tracking-tight mb-5" style={{ fontFamily: "'Space Grotesk', system-ui, sans-serif", fontSize: 'clamp(40px, 6vw, 62px)', letterSpacing: '-0.03em' }}>
        ...
        <section id="how" className="py-14 border-t border-white/[0.07]">
          <div className="text-[#F4E96B] text-xs tracking-[0.28em] uppercase mb-6" style={{ fontFamily: "'Space Mono', monospace" }}>How it works</div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              <div key={s.n} className="bg-[#0F1424] border border-white/[0.07] rounded-2xl p-5">
                <div className="text-[#F4E96B] text-[13px] font-bold tracking-wider" style={{ fontFamily: "'Space Mono', monospace" }}>
                  {s.n} {s.arrow && <span className="text-[#F4E96B]">→</span>}
                </div>
                <h3 className="font-semibold text-[19px] mt-3 mb-2 tracking-tight" style={{ fontFamily: "'Space Grotesk', system-ui, sans-serif" }}>{s.title}</h3>
        ...
        <section className="py-14 border-t border-white/[0.07]">
          <div className="text-[#F4E96B] text-xs tracking-[0.28em] uppercase mb-6" style={{ fontFamily: "'Space Mono', monospace" }}>Two ways in</div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-gradient-to-b from-[#151B30] to-[#0F1424] border border-[rgba(244,233,107,0.10)] rounded-2xl p-6">
              <div className="text-[#F4E96B] text-[11px] tracking-[0.2em] uppercase mb-3" style={{ fontFamily: "'Space Mono', monospace" }}>If you watch creators</div>
              <h3 className="font-bold text-[22px] tracking-tight mb-2" style={{ fontFamily: "'Space Grotesk', system-ui, sans-serif" }}>Bet on who blows up next.</h3>
            ...
            <div className="bg-gradient-to-b from-[#151B30] to-[#0F1424] border border-[rgba(244,233,107,0.10)] rounded-2xl p-6">
              <div className="text-[#F4E96B] text-[11px] tracking-[0.2em] uppercase mb-3" style={{ fontFamily: "'Space Mono', monospace" }}>If you are a creator</div>
              <h3 className="font-bold text-[22px] tracking-tight mb-2" style={{ fontFamily: "'Space Grotesk', system-ui, sans-serif" }}>Your growth is your stock.</h3>
        ...
        <section className="py-14 border-t border-white/[0.07]">
          <div className="bg-[#0F1424] border border-[rgba(244,233,107,0.10)] rounded-2xl p-6 flex flex-col sm:flex-row gap-4 items-start">
            <span className="text-[10.5px] tracking-[0.18em] uppercase font-bold bg-[#F4E96B] text-[#0A0D18] px-3 py-1.5 rounded-lg whitespace-nowrap" style={{ fontFamily: "'Space Mono', monospace" }}>Early access</span>
            <div>
              <h3 className="font-semibold text-lg mb-1.5" style={{ fontFamily: "'Space Grotesk', system-ui, sans-serif" }}>Right now, it&apos;s a game.</h3>
        ...
        <div className="text-center py-16 border-t border-white/[0.07]">
          <h2 className="font-bold tracking-tight mb-3" style={{ fontFamily: "'Space Grotesk', system-ui, sans-serif", fontSize: 'clamp(30px, 4.4vw, 44px)', letterSpacing: '-0.02em' }}>
        ...
        <footer className="text-center text-[#8A93B0] text-xs py-8 tracking-wider" style={{ fontFamily: "'Space Mono', monospace" }}>
