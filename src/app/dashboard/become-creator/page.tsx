      ...
      <div className="bg-card border border-edge rounded-2xl p-6 sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <p className="text-[#707A8A] text-xs mt-1">We&apos;ll review this to verify your audience.</p>
          </div>
          ...
          <p className="text-center text-xs text-[#707A8A]">Applications are reviewed within 24–48 hours.</p>
        </form>
      </div>
    </div>
  )
