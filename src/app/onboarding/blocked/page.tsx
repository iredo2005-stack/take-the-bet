  ...
  return (
    <main className="min-h-screen bg-bg flex items-center justify-center px-6">
      <div className="w-full max-w-md text-center">
        ...
        <p className="text-gray-400 leading-relaxed mb-8">You must be <strong className="text-white">18 or older</strong> to use Take The Bet. This platform involves real-money transactions and is not available to minors.</p>
