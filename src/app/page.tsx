    ...
    <main className="min-h-screen animate-bg-glow flex flex-col pb-16 sm:pb-0">
      ...
      <nav className="bg-card/80 backdrop-blur-sm px-5 py-2.5 flex items-center justify-between border-b border-edge sticky top-0 z-40">
        ...
        <div className="flex items-center gap-2.5">
          <Link href="/about" className="text-xs text-[#707A8A] hover:text-[#1E2329] transition-colors px-2 py-1">How it works</Link>
          <Link href="/sign-in" className="text-xs text-[#707A8A] hover:text-[#1E2329] transition-colors px-2 py-1">Log in</Link>
