  ...
  return (
    <div className="bg-card border border-edge rounded-2xl p-5 mb-6">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-[#707A8A] text-[10px] uppercase tracking-widest mb-1">Play Balance</p>
      ...
      <p className="text-[#707A8A] text-[10px] mt-2">Virtual play money — no real money involved.</p>
    </div>
  )
}
